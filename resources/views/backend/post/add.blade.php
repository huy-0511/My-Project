                ...
                <form role="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label >Tóm tắt bài viết</label>
                         <textarea class="form-control" name="post_desc" id="editor2" placeholder="Mô tả danh mục" >
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label >Nội dung bài viết</label>
                         <textarea class="form-control" name="post_content" id="editor3" placeholder="Mô tả danh mục" >
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label>Meta từ khóa</label>
                         <textarea class="form-control" name="post_meta_keywords" placeholder="Mô tả danh mục" >
                        </textarea>
                    </div>
                     <div class="form-group">
                        <label>Meta nội dung</label>
                         <textarea class="form-control" name="post_meta_desc" placeholder="Mô tả danh mục" >
                        </textarea>
                    </div>
                     <div class="form-group">
